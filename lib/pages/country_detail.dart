    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Center(child: Image.network(country.flag, width: 200)),
            SizedBox(height: 16),
            Text(
              'Nome oficial: ${country.officialName}',
            ...
            Text(
              'Moeda(s): ${currenciesStr.isNotEmpty ? currenciesStr : 'N/A'}',
            ),
            SizedBox(height: 16),
            if (country.googleMapsUrl != null)
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  final Uri url = Uri.parse(country.googleMapsUrl!);
